...
<html>
  ...
  <div class="interactiveContainer">
    <div class="tabBar">
      ...
      <div id="tab<?php echo $dim;?>" class="tabItem selected">Dimensi <?php echo $dim;?></div>
...
info.update = function (props) {
  ...
  this._div.innerHTML = (props ?
    '<div class="areaName">' + props.PROVINSI + '</div>' : '<div class="areaName faded"></div>') +
